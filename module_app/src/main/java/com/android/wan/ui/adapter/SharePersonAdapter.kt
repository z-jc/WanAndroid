...
class SharePersonAdapter : BaseQuickAdapter<SharePersonEntity.DataBean.ShareArticlesBean.DatasBean, BaseViewHolder>(
    ...
    override fun convert(holder: BaseViewHolder, item: SharePersonEntity.DataBean.ShareArticlesBean.DatasBean) {
    ...
    private fun addCollect(
        item: SharePersonEntity.DataBean.ShareArticlesBean.DatasBean,
        pos: Int,
        id: Int,
